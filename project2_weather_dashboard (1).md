...
export function CurrentWeatherCard({
  ...
  return (
    <div
      className={cn(
        "rounded-2xl border border-slate-200 bg-linear-to-br from-sky-50 to-white p-6 shadow-sm",
...
_Plan first. Build deliberately. Handle every failure. Ship with confidence._
